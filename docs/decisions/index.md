...
| [039](ADR-039.md) | 읽기 본문 서체를 Fontsource로 자체 호스팅한다 | Accepted (2026-09-03) |
| [040](ADR-040.md) | 읽기 설정은 쿠키에 담고, 읽기 라우트에 스크립트를 처음 허용한다 | Accepted (2026-09-03) |
| [041](ADR-041.md) | 장 이동은 View Transitions로 방향을 가진 전환을 준다 | Accepted (2026-09-03) |
| [042](ADR-042.md) | 스타일시트는 루트 라우트에서 부수효과로 import한다 | Accepted (2026-09-03) |
| [043](ADR-043.md) | 접근성이 걸린 위젯은 읽기 화면에서도 shadcn을 쓴다 | Accepted (2026-09-04) |
